...
(
    ...
    updated_at timestamp without time zone,
    deleted_at timestamp without time zone,
    employee_hospital_id bigint NOT NULL,
    CONSTRAINT "Staff_pkey" PRIMARY KEY (employee_id),
    CONSTRAINT "Employee_employee_identity_number_deleted_at_key" UNIQUE NULLS NOT DISTINCT (employee_identity_number, deleted_at),
    CONSTRAINT "Employee_employee_phone_number_deleted_at_key" UNIQUE NULLS NOT DISTINCT (employee_phone_number, deleted_at),
    CONSTRAINT "Employee_employee_hospital_id_fkey" FOREIGN KEY (employee_hospital_id)
    REFERENCES public."Hospital" (hospital_id) MATCH SIMPLE
                         ON UPDATE NO ACTION
                         ON DELETE NO ACTION
    NOT VALID,
    CONSTRAINT "Employee_employee_job_group_name_fkey" FOREIGN KEY (employee_job_group_name)
...
CREATE TABLE IF NOT EXISTS public."EmployeeWorkDay"
(
    employee_id bigint NOT NULL,
    day day_type NOT NULL,
    created_at timestamp without time zone NOT NULL DEFAULT now(),
    CONSTRAINT "EmployeeWorkDay_pkey" PRIMARY KEY (day, employee_id),
    CONSTRAINT "EmployeeWorkDay_employee_id_fkey" FOREIGN KEY (employee_id)
...
CREATE TABLE IF NOT EXISTS public."HospitalClinic"
(
    hospital_id bigint NOT NULL,
    clinic_name character varying COLLATE pg_catalog."default" NOT NULL,
    created_at timestamp without time zone NOT NULL DEFAULT now(),
    deleted_at timestamp without time zone,
    CONSTRAINT "HospitalClinic_pkey" PRIMARY KEY (hospital_id, clinic_name),
    CONSTRAINT "HospitalClinic_clinic_name_fkey" FOREIGN KEY (clinic_name)
    REFERENCES public."Clinic" (clinic_name) MATCH SIMPLE
                         ON UPDATE NO ACTION
                         ON DELETE NO ACTION
    NOT VALID,
    CONSTRAINT "HospitalClinic_hospital_id_fkey" FOREIGN KEY (hospital_id)
    REFERENCES public."Hospital" (hospital_id) MATCH SIMPLE
                         ON UPDATE NO ACTION
                         ON DELETE NO ACTION
    NOT VALID
...
(
    ...
    CONSTRAINT "Title_title_name_title_jobgroup_name_key" UNIQUE NULLS NOT DISTINCT (title_name, jobgroup_name),
    CONSTRAINT "Title_title_jobgroup_name_fkey" FOREIGN KEY (jobgroup_name)
    REFERENCES public."JobGroup" (jobgroup_name) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    );
...
(
    ...
    user_hospital_id bigint NOT NULL,
    ...
    CONSTRAINT "User_hospital_id_fkey" FOREIGN KEY (user_hospital_id)
    REFERENCES public."Hospital" (hospital_id) MATCH SIMPLE
                         ON UPDATE NO ACTION
                         ON DELETE NO ACTION
    NOT VALID
...
INSERT INTO "Title" (title_name,jobgroup_name) VALUES
                                                   ('Uzman', 'Doktor'),
                                                   ('Asistan', 'Doktor'),
